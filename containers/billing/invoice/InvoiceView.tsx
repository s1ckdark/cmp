    ...
    <>
      ...
      <div className={Styles.container}>
        <div id="invoice">
          <div className={Styles.hGroup}>
            ...
            <span className={Styles.date}>
              <label htmlFor="청구년월">청구년월</label>
              {nextMonth}({currentMonth}분)
            </span>
          </div>
        ...
        <div className={Styles.btnArea}>
          <Button onClick={() => handlePdf('invoice')} className={`${Styles.btn} ${Styles.pdfBtn} flex justify-end mt-10`} skin="green">
            pdf
          </Button>
          <Button className={`${Styles.btn} ${Styles.backBtn} flex justify-end mt-10`} onClick={() => router.back()} skin="green">
            목록
          </Button>
        </div>
      </div>
