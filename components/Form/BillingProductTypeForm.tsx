...
const BillingProductForm = ({ prodType, pageType, product }: IBillingProductForm) => {
  ...
  return (
    <>
      <div className={`${styles[prodType]} ${styles[pageType]}`}>
        <table>
          <thead>
            <tr>
              <th></th>
            ...
            {fields.map((field, index) => {
              ...
              return (
                <tr key={field.id}>
                  ...
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.prodId`, { disabled: false, required: false })} />
                  </td>
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.prodName`, { disabled: false, required: false })} />
                  </td>
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.prodDetailType`, { disabled: false, required: false })} />
                  </td>
                  {prodType === 'billingSwList' && (
                    <td>
                      <input type="text" readOnly={true} {...register(`${prodType}.${index}.prodDetailTypeStd`, { disabled: isDisabled, required: false })} />
                    </td>
                  )}
                  <td>
                    <input type="number" readOnly={true} {...register(`${prodType}.${index}.stdPrice`, { disabled: isDisabled, required: false, valueAsNumber: true })} />
                  </td>
                  {prodType === 'billingSwList' && (
                    <td>
                      <input type="number" readOnly={isDisabled} {...register(`${prodType}.${index}.expPrice`, { disabled: isDisabled, required: true })} />
                    </td>
                  )}
                  <td>
                    <input type="number" readOnly={isDisabled} {...register(`${prodType}.${index}.discountRate`, { disabled: isDisabled, required: true, valueAsNumber: true })} />
                  </td>
                  {prodType === 'billingMspList' && (
                    <td>
                      <input type="number" readOnly={isDisabled} {...register(`${prodType}.${index}.qty`, { disabled: isDisabled, required: true, valueAsNumber: true })} />
                    </td>
                  )}
                  <td>
                    <input type="number" readOnly={true} {...register(`${prodType}.${index}.estimateuseAmount`, { disabled: isDisabled, valueAsNumber: true, required: true })} value={estimateUseAmount} />
                  </td>
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.service_start_date`, { disabled: isDisabled, required: false })} />
                  </td>
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.service_end_date`, { disabled: isDisabled, required: false })} />
                  </td>
                  <td>
                    <input type="text" readOnly={true} {...register(`${prodType}.${index}.comment`, { disabled: isDisabled, required: false })} />
                  </td>
                </tr>
              );
            })}
