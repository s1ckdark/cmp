...
const RegistrationForm = ({ data, type }: IRegistrationFormProps) => {
    ...
    const [defaultPrivilegeOptions, setDefaultPrivilegeOptions] = useState<
        any[]
    >([]);
    ...
    const passwordChange = async () => {
        const newPassword: any = (
            document.querySelector(".modalPassword") as HTMLInputElement
        )?.value;
        const confirmPassword: any = (
            document.querySelector(".modalComfirmPassword") as HTMLInputElement
        )?.value;
        ...
        const getPrivilegeOptions = async () => {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                if (result) {
                    ...
                    const defaultPrivileges = privilegeOptions.filter(
    ...
    return (
        <>
            <form
                className={`${styles.template} ${styles[type]}`}
            ...
            >
                ...
                <div className={styles.inputGroup}>
                    {type === "register" ? (
                        <div className="flex items-end">
                            ...
                            <div
                                className={`${styles.btnArea} ${styles.btnPasswordCheck}`}
                            >
                                <Button
                                    type="button"
                                    skin="gray"
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <input
                                ...
                                {...field}
                                defaultValue={mobile}
                                placeholder="010-XXXX-XXXX 양식으로 입력하세요"
                            />
                        )}
                    />
                    {errors.mobile && (
                ...
                <div className={styles.inputGroup}>
                    <div className="flex items-end">
                        ...
                        {type === "edit" || type === "register" ? (
                            <div
                                className={`${styles.btnArea} ${styles.btnAddrSearch}`}
                            >
                                <Button
                                    type="button"
                                    onClick={() => openModal("address")}
                ...
                <div className={styles.inputGroup}>
                    <div className="flex items-end">
                        ...
                        {type === "edit" || type === "register" ? (
                            <div
                                className={`${styles.btnMemberSearch} ${styles.btnArea}`}
                            >
                                <Button
                                    type="button"
                                    onClick={() => openModal("member")}
            ...
            {type === "edit" ? (
                <div
                    id="passwordModal"
                    className={`${styles.modal} ${styles.passwordModal}`}
                >
                    <span
                        className={styles.closeBtn}
                        onClick={() => pwCloseModal()}
                    >
                        &times;
                    </span>
                    <div className={styles.innerModal}>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <input
                                ...
                                type="password"
                                className="modalComfirmPassword"
                            />
                        </div>
